...
const chessBoard = [
    // ^ Black = 1
    { piecetype: piecetypes.sipahi, teamcolor: teamcolors.black, PieceID: 0, x: 0, y: 6 }, // sipahi
    ...
    { piecetype: piecetypes.hathi, teamcolor: teamcolors.black, PieceID: 0, x: 0, y: 7 }, // hathi
    { piecetype: piecetypes.hathi, teamcolor: teamcolors.black, PieceID: 1, x: 7, y: 7 },
    { piecetype: piecetypes.ghodo, teamcolor: teamcolors.black, PieceID: 0, x: 1, y: 7 }, // ghodo
    { piecetype: piecetypes.ghodo, teamcolor: teamcolors.black, PieceID: 1, x: 6, y: 7 },
    { piecetype: piecetypes.uut, teamcolor: teamcolors.black, PieceID: 0, x: 2, y: 7 }, // uut
    { piecetype: piecetypes.uut, teamcolor: teamcolors.black, PieceID: 1, x: 5, y: 7 },
    { piecetype: piecetypes.vajir, teamcolor: teamcolors.black, PieceID: 0, x: 3, y: 7 }, // vajir
    { piecetype: piecetypes.king, teamcolor: teamcolors.black, PieceID: 0, x: 4, y: 7 }, // king

    // ^ White = 0
    { piecetype: piecetypes.sipahi, teamcolor: teamcolors.white, PieceID: 0, x: 0, y: 1 }, // sipahi (left side thi)
    ...
    { piecetype: piecetypes.hathi, teamcolor: teamcolors.white, PieceID: 0, x: 0, y: 0 }, // hathi
    { piecetype: piecetypes.hathi, teamcolor: teamcolors.white, PieceID: 1, x: 7, y: 0 },
    { piecetype: piecetypes.ghodo, teamcolor: teamcolors.white, PieceID: 0, x: 1, y: 0 }, // ghodo
    { piecetype: piecetypes.ghodo, teamcolor: teamcolors.white, PieceID: 1, x: 6, y: 0 },
    { piecetype: piecetypes.uut, teamcolor: teamcolors.white, PieceID: 0, x: 2, y: 0 }, // uut
    { piecetype: piecetypes.uut, teamcolor: teamcolors.white, PieceID: 1, x: 5, y: 0 },
    { piecetype: piecetypes.vajir, teamcolor: teamcolors.white, PieceID: 0, x: 3, y: 0 }, // vajir
...
const findPosition = (t_position: Position, chessBoard: Position[]) : Position | null => {
    const filterChessBoard = chessBoard.filter((position : Position) => t_position.x === position.x && t_position.y === position.y)
...
export const isKing = (t_position: Position, chessBoard: Position[]) => {
        ...
        if (sideOrStreight) {
            ...
            if (!leftOrRight) {
                ...
                if (leftCrossUp) {
                    ...
                    if (isValidPosition(leftOne)) return leftOne;
                    else return null;
                } else return null;
            } else {
                ...
                if (rightCrossUp) {
                    ...
                    if (isValidPosition(rightOne)) return rightOne;
                    else return null;
                } else return null;
            }
        }
...
const canPawnKillKing = (teamColor: number, chessBoard: Position[]) : object | null => {
    var killFound = null;
    var path = [];
    chessBoard.every((position: Position) => {
...
const canKnightKillKing = (teamColor: number, chessBoard: Position[]) : object | null => {
    var killFound = null;
    var path = []
    chessBoard.every((position: Position) => {
...
const canBishopKillKing = (teamColor: number, chessBoard: Position[]) :  object | null => {
    var killFound = null;
    var path = [];
    chessBoard.every((position: Position) => {
            ...
            Object.keys(directionConfig).every(direction => {
                ...
                while (true) {
                    ...
                    if (cross && isValidPosition(cross)) {
                        ...
                        if (crossPosition) break;
                        else gaps.push(cross)
                    } else break;
                    steps++;
                }
...
const canRookKillKing = (teamColor: number, chessBoard: Position[]) : object | null => {
    var killFound = null;
    var path = [];
            ...
            Object.keys(rookDirectionsConfig).every(direction => {
                ...
                while(true) {
                    ...
                    if (oneStreightMove && isValidPosition(oneStreightMove)) {
                        ...
                        if (streightMove) break;
                        else gaps.push(oneStreightMove);
                    } else break;
                    steps++;
                }
                if (isKingKilled) {
...
const canQueenKillKing = (teamColor: number, chessBoard: Position[]) : object | null => {
    var killFound = null;
    var path = [];
    chessBoard.every((position: Position) => {
...
const isKingInDanger = (teamColor: number, chessBoard: Position[]) : InDanger[] | null => {
    var dangers = [];
    ...
    if (isPawnDanger) dangers.push(isPawnDanger); 
    if (isKnightDanger) dangers.push(isKnightDanger); 
    if (isBishopDanger) dangers.push(isBishopDanger); 
    if (isRookDanger) dangers.push(isRookDanger); 
    if (isQueenDanger) dangers.push(isQueenDanger);
...
const board = [
    // ^ Black = 1
    { piecetype: 0, teamcolor: 1, PieceID: 0, x: 0, y: 6 }, // sipahi
    ...
    { piecetype: 1, teamcolor: 1, PieceID: 0, x: 0, y: 7 }, // hathi
    { piecetype: 1, teamcolor: 1, PieceID: 1, x: 7, y: 7 },
    { piecetype: 2, teamcolor: 1, PieceID: 0, x: 1, y: 7 }, // ghodo
    { piecetype: 2, teamcolor: 1, PieceID: 1, x: 6, y: 7 },
    { piecetype: 3, teamcolor: 1, PieceID: 0, x: 2, y: 7 }, // uut
    { piecetype: 3, teamcolor: 1, PieceID: 1, x: 5, y: 7 },
    { piecetype: 4, teamcolor: 1, PieceID: 0, x: 4, y: 6 }, // vajir
    { piecetype: 5, teamcolor: 1, PieceID: 0, x: 4, y: 7 }, // king
  
    // ^ White = 0
    { piecetype: 0, teamcolor: 0, PieceID: 0, x: 0, y: 1 }, // sipahi (left side thi)
    ...
    { piecetype: 1, teamcolor: 0, PieceID: 0, x: 0, y: 0 }, // hathi
    { piecetype: 1, teamcolor: 0, PieceID: 1, x: 7, y: 0 },
    { piecetype: 2, teamcolor: 0, PieceID: 0, x: 1, y: 0 }, // ghodo
    { piecetype: 2, teamcolor: 0, PieceID: 1, x: 6, y: 0 },
    { piecetype: 3, teamcolor: 0, PieceID: 0, x: 2, y: 0 }, // uut
    { piecetype: 3, teamcolor: 0, PieceID: 1, x: 5, y: 0 },
    { piecetype: 4, teamcolor: 0, PieceID: 0, x: 3, y: 0 }, // vajir
